...
export function NotificationBell() {
  ...
  return (
    <div className="relative">
      <button onClick={toggle} title="Notifications" className="relative rounded border border-neutral-300 px-2 py-1 text-sm hover:bg-neutral-100 dark:border-neutral-700 dark:hover:bg-neutral-800">
        🔔
        {unread > 0 ? (
      ...
      {open ? (
        <div className="absolute right-0 z-50 mt-1 max-h-96 w-80 overflow-y-auto rounded-lg border border-neutral-200 bg-white p-2 shadow-lg dark:border-neutral-700 dark:bg-neutral-900">
          ...
          {items.length === 0 ? <p className="px-1 py-2 text-xs text-neutral-400">No notifications.</p> : null}
